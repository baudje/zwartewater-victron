...
```bash
sshpass -p 'Zwartewater' scp -r fla-equalisation/ root@venus.local:/tmp/fla-equalisation/
sshpass -p 'Zwartewater' ssh root@venus.local 'bash /tmp/fla-equalisation/install.sh'

sshpass -p 'Zwartewater' scp -r fla-charge/ root@venus.local:/tmp/fla-charge/
sshpass -p 'Zwartewater' ssh root@venus.local 'bash /tmp/fla-charge/install.sh'
```
