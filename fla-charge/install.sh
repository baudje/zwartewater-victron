...
if [ -d "${SCRIPT_DIR}/../fla-shared" ]; then
    for f in __init__.py relay_control.py voltage_matching.py aggregate_driver.py lock.py dbus_monitor.py alerting.py temp_battery.py temp_battery_process.py temp_compensation.py takeover.py web_engine.py unified_page.py log_tail.py run_history.py history_buffer.py; do
